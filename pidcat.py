...
parser.add_argument('--header-width', metavar='N', dest='header_width', type=int, default=0, help='Width of customized log header. If you have your own header besides Android log header, this option will futher indent your log with additional width')
...
parser.add_argument('--tee-original', dest='original_file_name', type=str, default='', help='Besides stdout output, also output the unfiltered result (no grep/grepv, i.e., original adb result) to the file')
